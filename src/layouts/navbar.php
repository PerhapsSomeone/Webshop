...
<div id="flipkart-navbar">
    <div class="container">
        ...
        <div class="row row2">
            <div class="col-sm-2">
                <h2 style="margin:0px;"><span class="smallnav menu" onclick="openNav()">☰ <?= getenv("SHOP_NAME"); ?></span></h2>
                <a style="text-decoration: none; color: white" href="/index.php"><h3 style="margin:0px;"><span class="largenav"><?= getenv("SHOP_NAME"); ?></span></h3></a>
            </div>
            <div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                <div class="row">
                    <form method="get" action="/search.php">
                        <input class="flipkart-navbar-input col-xs-11" type="text" placeholder="Search for products..." name="search">
